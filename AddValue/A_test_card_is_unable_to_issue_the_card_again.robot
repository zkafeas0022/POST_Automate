...
Add Value Cash Payment
    ...
    \    Setup Test Data
    \    ${ExecuteTestResult}	Run Keyword And Ignore Error    Add Value Cash Payment    ${iData}
...
Add Value Cash Payment
    [Arguments]    ${iData}
    Post Setup
    Verify display the card is a test card
...
${dir_sim_reader_card_sale}  C:/Users/THANATHIP N/TestCase/Backupsimreader/test flag1/SimulateCardReader.ini
...
${Excelname}    Data_AddValue_TS001_EN_Cash_Payment.xlsx				