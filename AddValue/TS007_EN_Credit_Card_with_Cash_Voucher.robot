...
EN Credit Card with Cash Voucher
    ...
    Cash with Cash Voucher add value and confrim transaction    ${Add_Value}    ${iData}    ${Credit_Card_No}    ${Voucher}    ${Voucher_No}
    Cash with Cash Voucher Verify Total payment    ${Add_Value}    ${Credit_Card_No}    ${Voucher}    ${Voucher_No}
    log    ${PurseAddValue}
...
Cash with Cash Voucher add value and confrim transaction
    [Arguments]    ${Add_Value}    ${iData}    ${Credit_Card_No}    ${Voucher}    ${Voucher_No}
    Attach Window	id:MainWindow	
...
Cash with Cash Voucher Verify Total payment
    [Arguments]    ${Add_Value}    ${Credit_Card_No}    ${Voucher}    ${Voucher_No}
    ...
    #Payment Mode
    #${Cash}    Evaluate    ${Add_Value}-${Voucher}
    #${Cash}    Evaluate    ('{:,.2f}'.format( ${Cash}))
    ${Credit_Card}    Evaluate    ${Add_Value}-${Voucher}
    ...
    ${PurseAfterAddValue}    Evaluate    ${PurseBeforeAddValue}+${Add_Value}
    ...
    Verify Text In Textbox    id:ControlBonusInformationB_BonusAfterCardSale_textbox    ${zero_baht}
    #Payment
    ${Total_Payment}    Evaluate    ${Credit_Card}+${Voucher}
    ${Total_Payment}    Evaluate    ('{:,.2f}'.format(${Total_Payment}))
    Verify Text In Textbox	id:ControlPayment_TotalAmountReceived_TextBox	${Credit_Card}
    Verify Text In Textbox	id:ControlPayment_TotalPayment_TextBox	${Total_Payment}
...
${Excelname}    Data_AddValue_TS007_EN_Credit_Card_with_Cash_Voucher.xlsx