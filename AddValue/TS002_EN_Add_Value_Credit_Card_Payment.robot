...
Credit Card Payment
    ...
    \    ${ExecuteTestResult}	Run Keyword And Ignore Error    Credit Card Payment    ${iData}
...
Credit Card Payment
    ...
    ${Credit_Card}    Get Value Of Test Data Request By Name	${iData}	Credit_Card	
    ${PurseBeforeAddValue}    Verify that all function of Add value page    ${CardDeposit}
    ${Credit_Card}    Credit Card add value and confrim transaction    ${Add_Value}    ${Credit_Card_No}    ${iData}    ${CardDeposit}
    Credit Card Verify Total payment    ${Add_Value}    ${Credit_Card_No}    ${PurseBeforeAddValue}
...
Credit Card add value and confrim transaction
    [Arguments]    ${Add_Value}    ${Credit_Card_No}    ${iData}    ${CardDeposit}
    Attach Window	id:MainWindow	
    ...
    ${Add_Value}    evaluate    ('{:,.2f}'.format(${Add_Value}))
    Verify Text In Textbox	id:ControlPayment_TotalAmountReceived_TextBox	${Add_Value}
...
Credit Card Verify Total payment
    [Arguments]    ${Add_Value}    ${Credit_Card_No}    ${PurseBeforeAddValue}
    ...
    Verify Text In Textbox    id:ControlPaymentMode_CreditCard_textbox    ${Add_Value}
...
${Excelname}    Data_AddValue_TS002_EN_Credit_Card_Payment.xlsx				