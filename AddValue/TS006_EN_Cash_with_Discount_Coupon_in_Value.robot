...
***Test Cases***
EN Cash with Discount Coupon in Value
    ...
    \    ${ExecuteTestResult}	Run Keyword And Ignore Error    EN Cash with Discount Coupon in Value    ${iData}
...
Cash with Discount Coupon in Percentage Verify Total payment
    ...
    #Payment Mode
    ${Cash}    Evaluate    ${Add_Value}-${Discount_Coupon}
    ${Bonus}    Evaluate    ${Add_Value}-${Cash}
...
${Project_Name}    Devlop
${Excelname}    Data_AddValue_TS006_EN_Cash_with_Discount_Coupon_in_Value.xlsx