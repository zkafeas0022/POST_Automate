...
Cash with Discount Coupon in Percentage Verify Total payment
    ...
    log    ${Bonus}
    ${Credit_Card}    Run keyword If    '${Discount_Coupon}'=='100'   set Variable    0    ELSE    Evaluate    ${Add_Value}-${Bonus}
...
${Project_Name}    Devlop
${Excelname}    Data_AddValue_TS008_EN-Credit_Card_with_Discount_Coupon_in_Percentage.xlsx