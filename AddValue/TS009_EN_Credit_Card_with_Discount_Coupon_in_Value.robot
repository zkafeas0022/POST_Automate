...
***Test Cases***
EN Credit Card with Discount Coupon in Value
    ...
    \    Setup Test Data
    \    ${ExecuteTestResult}	Run Keyword And Ignore Error    EN Credit Card with Discount Coupon in Value    ${iData}
    \    ${Total_Addvalue}    Evaluate    ${Add_Value}+${Total_Addvalue} 
    log    ${Total_Addvalue}
    Close Application
...
EN Credit Card with Discount Coupon in Value
    ...
    Cash with Discount Coupon in Percentage add value and confrim transaction    ${Add_Value}    ${iData}    ${Discount_Coupon}    ${Voucher_No}    ${PurseBeforeAddValue}    ${Credit_Card_No}
    Cash with Discount Coupon in Percentage Verify Total payment    ${Discount_Coupon}    ${Voucher_No}    ${Add_Value}    ${PurseBeforeAddValue}    ${Credit_Card_No}
...
Cash with Discount Coupon in Percentage add value and confrim transaction    
    [Arguments]    ${Add_Value}    ${iData}    ${Discount_Coupon}    ${Voucher_No}    ${PurseBeforeAddValue}    ${Credit_Card_No}
    Attach Window	id:MainWindow	
...
Cash with Discount Coupon in Percentage Verify Total payment
    [Arguments]    ${Discount_Coupon}    ${Voucher_No}    ${Add_Value}    ${PurseBeforeAddValue}    ${Credit_Card_No}
    ...
    #Payment Mode
    ${Credit_Card}     Evaluate    (${Add_Value}-${Discount_Coupon})
    ${Bonus}     Evaluate    ${Add_Value}-${Credit_Card}
    ...
    Verify Text In Textbox    id:ControlPaymentMode_CreditCard_textbox     ${Credit_Card}
    ...
    Verify Label    id:ControlPaymentMode_VoucherDigit_label    Baht
    ...
    ${PurseAfterAddValue}    evaluate    ${PurseBeforeAddValue}+${Credit_Card}
    ${PurseBeforeAddValue}   evaluate    ('{:,.2f}'.format(${PurseBeforeAddValue}))
    Verify Text In Textbox	id:ControlCSCInformationB_PurseBeforeAddValue_TextBox    ${PurseBeforeAddValue}
    Verify Text In Textbox	id:ControlCSCInformationB_ValueAddedtoPurse_TextBox    ${Credit_Card}
    ...
    #Payment
    #${Change_Due}    Evaluate    ${Cash_Amount_Received}-${Credit_Card}
...
${Project_Name}    Devlop
${Excelname}    Data_AddValue_TS009_EN_Credit_Card_with_Discount_Coupon_in_Value.xlsx