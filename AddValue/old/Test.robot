...
EN Cash with Discount Coupon in Percentage
    ...
    Cash with Discount Coupon in Percentage add value and confrim transaction    ${Add_Value}    ${iData}    ${Cash_Amount_Received}    ${Discount_Coupon}    ${Voucher_No}    ${PurseBeforeAddValue}    ${ErrorSummary_excel}    ${ErrorMessage_excel}
    Verify Error Message    ${TestDataReponse}
...
Post Setup
    ...
    #@{Data}	Fetch BUS Data From Excel	${Project_Name}	${TEST_NAME}	${Excelname}	response
    ...
    Set Global Variable    @{TestDataReponse}   #Chang @ to $
...
#Add Value
    ...
    #Run keyword IF    '${Check_Error_AddValue}'=='True'    Close Application
...
#Payment Mode
    ...
    Run Keyword If   ${Add_Value}>9999    Attach Window    id:Information_Dialog
    ${Check_Error_AddValue}    Run Keyword And Return Status    Wait Until Item Exists    id:Information_Summary    5s
    ${Check_Error_AddValue}    Run Keyword And Return Status    Wait Until Item Exists    id:Information_Message    5s
    ${Text_Error_App_Summary}    Run Keyword If    '${Check_Error_AddValue}'=='True'    Get Text From Label    id:Information_Summary
    log    ${Text_Error_App_Summary}
    ${Text_Error_App_Message}    Run Keyword If    '${Check_Error_AddValue}'=='True'    Get Text From Label    id:Information_Message
    log    ${Text_Error_App_Message}
    should Contain    ${Text_Error_App_Summary}    ${ErrorSummary_excel}
    should Contain    ${Text_Error_App_Message}    ${ErrorMessage_excel}
