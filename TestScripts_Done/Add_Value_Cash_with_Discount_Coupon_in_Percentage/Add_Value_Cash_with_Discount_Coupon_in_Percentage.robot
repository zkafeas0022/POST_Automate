...
Cash with Discount Coupon in Percentage add value and confrim transaction
   ...
   #Run keyword If    '${Cash_Amount_Received_Input}'!='${EMPTY}'    Input Text To Textbox    id:ControlCashAmountReceive_CashReceived_textbox    ${Cash_Amount_Received_Input}
    ...
    #${Change_Due}    Run keyword If    '${Amount_Received_cash}'=='${Amount_payment}'    Set Variable    0    ELSE IF    '${Amount_Received_cash}'!='${Amount_payment}'    Evaluate    ${Amount_Received_cash}-${Amount_payment}
...
${Project_Name}    Devlop
${Excelname}    Data_Add_Value_Cash_with_Discount_Coupon_in_Percentage.xlsx