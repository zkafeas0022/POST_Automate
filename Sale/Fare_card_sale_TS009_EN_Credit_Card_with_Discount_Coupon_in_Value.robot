...
EN Credit Card with Discount Coupon in Value
    ...
    ${Amount_Discount}    Credit Card with Discount Coupon in Value add value and confrim transaction    ${Initial_Add_Value}    ${iData}    ${Credit_Card_No}    ${Discount_Coupon}    ${Voucher_No}    ${CardDeposit}
    Credit Card with Discount Coupon in Value Verify Total payment    ${Amount_Discount}    ${Initial_Add_Value}    ${CardDeposit}    ${Credit_Card_No}    ${Discount_Coupon}    ${Voucher_No}
...
Credit Card with Discount Coupon in Value add value and confrim transaction
    [Arguments]    ${Initial_Add_Value}    ${iData}    ${Credit_Card_No}    ${Discount_Coupon}    ${Voucher_No}    ${CardDeposit}
    Attach Window	id:MainWindow	
...
Credit Card with Discount Coupon in Value Verify Total payment
    [Arguments]    ${Amount_Discount}    ${Initial_Add_Value}    ${CardDeposit}    ${Credit_Card_No}    ${Discount_Coupon}    ${Voucher_No}
...
${Project_Name}    Devlop
${Excelname}    Data_Fare_card_sale_TS009_EN_Credit_Card_with_Discount_Coupon_in_Value.xlsx