...
EN Cash Payment
    ...
    \    ${ExecuteTestResult}	Run Keyword And Ignore Error    EN Cash Payment    ${iData}
...
EN Cash Payment
    ...
    Add Value and cash Amount Received   ${Initial_Add_Value}    ${Cash_Amount_Received}    ${Cash_Amount_Received_Input}    ${iData}
    Verify Total payment and confrim transaction    ${Initial_Add_Value}    ${CardDeposit}    ${Cash_Amount_Received}
...
Add Value and cash Amount Received
    [Arguments]    ${Initial_Add_Value}    ${Cash_Amount_Received}    ${Cash_Amount_Received_Input}    ${iData}
    Attach Window	id:MainWindow	
...
Verify Total payment and confrim transaction
    [Arguments]    ${Initial_Add_Value}    ${CardDeposit}    ${Cash_Amount_Received}    
...
${Project_Name}    Devlop
${Excelname}    Data_Fare_card_sale_TS001_EN_Cash_Payment.xlsx
