...
***Test Cases***
EN Cash with Discount Coupon in Percentage
    ...
    \    ${ExecuteTestResult}	Run Keyword And Ignore Error    EN Cash with Discount Coupon in Percentage    ${iData}
...
EN Cash with Discount Coupon in Percentage
    ...
    ${Amount_payment}    Cash with Discount Coupon in Percentage add value and confrim transaction    ${Initial_Add_Value}    ${iData}    ${Cash_Amount_Received}    ${Discount_Coupon}    ${Voucher_No}    ${CardDeposit}
    Cash with Discount Coupon in Percentage Verify Total payment    ${Amount_payment}    ${Discount_Coupon}    ${Voucher_No}    ${Initial_Add_Value}    ${CardDeposit}
...
Cash with Discount Coupon in Percentage add value and confrim transaction    
    [Arguments]    ${Initial_Add_Value}    ${iData}    ${Cash_Amount_Received}    ${Discount_Coupon}    ${Voucher_No}    ${CardDeposit}
    Attach Window	id:MainWindow	
...
Cash with Discount Coupon in Percentage Verify Total payment
    [Arguments]    ${Amount_payment}    ${Discount_Coupon}    ${Voucher_No}    ${Initial_Add_Value}    ${CardDeposit}
...
${Project_Name}    Devlop
${Excelname}    Data_Fare_card_sale_TS005_EN_Cash_with_Discount_Coupon_in_Percentage.xlsx