...
EN Credit Card Payment
    ...
    \    ${ExecuteTestResult}	Run Keyword And Ignore Error    EN Credit Card Payment    ${iData}
...
EN Credit Card Payment
    ...
    ${Credit_Card}    Credit Card add value and confrim transaction    ${Initial_Add_Value}    ${Credit_Card_No}    ${iData}    ${CardDeposit}    
    Credit Card Verify Total payment    ${Credit_Card}    ${Initial_Add_Value}    ${CardDeposit}    ${Credit_Card_No}
...
Credit Card add value and confrim transaction
    [Arguments]    ${Initial_Add_Value}    ${Credit_Card_No}    ${iData}    ${CardDeposit}
    Attach Window	id:MainWindow	
...
Credit Card Verify Total payment
    [Arguments]    ${Credit_Card}    ${Initial_Add_Value}    ${CardDeposit}    ${Credit_Card_No}
...
${Project_Name}    DevlopPoch5191
${Excelname}    Data_Fare_card_sale_TS002_EN_Credit_Card_Payment.xlsx				
