...
***Test Cases***
EN Credit Card with Discount Coupon in Percentage
    ...
    \    ${ExecuteTestResult}	Run Keyword And Ignore Error    EN Credit Card with Discount Coupon in Percentage    ${iData}
...
EN Credit Card with Discount Coupon in Percentage
    ...
    ${Credit_Card_No}    Get Value Of Test Data Request By Name	${iData}	Credit_Card_No
    ...
    ${Amount_payment}    Credit Card with Discount Coupon in Percentage add value and confrim transaction    ${Initial_Add_Value}    ${iData}    ${Credit_Card_No}    ${Discount_Coupon}    ${CardDeposit}    ${Voucher_No}
    Credit Card with Discount Coupon in Percentage Verify Total payment    ${Amount_payment}    ${Initial_Add_Value}    ${CardDeposit}    ${Discount_Coupon}    ${Credit_Card_No}    ${Voucher_No}
...
Credit Card with Discount Coupon in Percentage add value and confrim transaction
    [Arguments]    ${Initial_Add_Value}    ${iData}    ${Credit_Card_No}    ${Discount_Coupon}    ${CardDeposit}    ${Voucher_No}
    Attach Window	id:MainWindow	
    ...
    Verify Text In Textbox	id:ControlPayment_TotalAmountReceived_TextBox    ${Amount_payment}
...
Credit Card with Discount Coupon in Percentage Verify Total payment
    [Arguments]    ${Amount_payment}    ${Initial_Add_Value}    ${CardDeposit}    ${Discount_Coupon}    ${Credit_Card_No}    ${Voucher_No}
    ...
    Verify Text In Textbox    id:ControlPaymentMode_CreditCard_textbox    ${Amount_payment}
...
${Project_Name}    Devlop
${Excelname}    Data_Fare_card_sale_TS008_EN_Credit_Card_with_Discount_Coupon_in_Percentage.xlsx