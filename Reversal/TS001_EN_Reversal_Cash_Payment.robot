...
Reversal Cash Payment
    ...
    Cash Payment add value and confrim transaction    ${Add_Value}    ${iData}    ${Cash_Amount_Received}    ${Cash_Amount_Received_Input}
    Cash Payment Verify Total payment    ${Add_Value}    ${PurseBeforeAddValue}    ${Cash_Amount_Received}
    Verify Item Fare card Reversal
...
tttt
    ...
    ${Check_Active_Mainwindow}    Run Keyword And Return Status    Wait Until Item Exists    ${MainWindow}    10s
    Run keyword IF    '${Check_Active_Mainwindow}'=='True'    Attach Window    ${MainWindow}
    ${Check_Active_Warning_Dialog}    Run Keyword And Return Status    Wait Until Item Exists    ${Warning_Dialog}    10s
    Run keyword IF    '${Check_Active_Warning_Dialog}'=='True'    Attach Window    ${Warning_Dialog}
    ${Check_Active_Warning_OKButton}    Run Keyword And Return Status    Wait Until Item Exists    ${Warning_OKButton}    10s
    Run keyword IF    '${Check_Active_Warning_OKButton}'=='True'    Attach Window    ${Warning_OKButton}
    ${Check_Active_Mainwindow}    Run Keyword And Return Status    Wait Until Item Exists    ${MainWindow}    5s
    Run keyword IF    '${Check_Active_Mainwindow}'=='True'    Attach Window    ${MainWindow}
    Input Text To Textbox    ${Path_userid}    ${POST_USER}
    Input Text To Textbox    ${Path_Password}    ${POST_PASS}
    Click Button    ${Path_LoginButton}
...
Cash Payment add value and confrim transaction
...
Verify Item Fare card Reversal
    Click button    id:ControlOption_Reversal_button
    #Select reversal operation
    Item Should Be Enabled    id:ControlReversalOperation_AddValueReversal_Checkbox
    #Add value reversal 
    Item Should Be Disabled    id:ControlAddValueReversal_BeforeReversal_TextBox
    Item Should Be Disabled    id:ControlAddValueReversal_ValueReversedFromPurse_Text
    Item Should Be Disabled     id:ControlAddValueReversal_PurseAfterReversal_TextBox
    #Last add value information
    Item Should Be Disabled    id:ControlLastAddValueInformation_CSN_TextBox
    Item Should Be Disabled    id:ControlLastAddValueInformation_DateAndTime_TextBox
    Item Should Be Disabled    id:ControlLastAddValueInformation_PaymentMeans_TextBox
    Item Should Be Disabled    id:ControlLastAddValueInformation_PaymentMeans_TextBox
    Item Should Be Disabled    id:ControlLastAddValueInformation_Location_TextBox
    Item Should Be Disabled    id:ControlLastAddValueInformation_SAMID_Label
    #STP issue reversal
    Item Should Be Disabled    id:ControlSTPIssueReversal_PassStatus_TextBox
    Item Should Be Disabled    id:ControlSTPIssueReversal_RideRemaining_TextBox
    #Last issue STP informantion
    Item Should Be Disabled    id:ControlLastIssueSTPInformation_PassName_textbox
    Item Should Be Disabled    id:ControlLastIssueSTPInformation_CSN_textbox
    Item Should Be Disabled    id:ControlLastIssueSTPInformation_DateTime_textbox
    Item Should Be Disabled    id:ControlLastIssueSTPInformation_Price_textbox
    Item Should Be Disabled    id:ControlLastIssueSTPInformation_PaymentMeans_textbox
    Item Should Be Disabled    id:ControlLastIssueSTPInformation_Location_textbox
    Item Should Be Disabled    id:ControlLastIssueSTPInformation_SAMID_textbox




***Variables***
${MainWindow}    id:MainWindowv
...
${dir_sim_reader_card_sale}  C:/Users/THANATHIP N/TestCase/Backupsimreader/Reversal/Std_Adl_Status_2/SimulateCardReader.ini
...
${Excelname}    Data_Reversal_TS001_EN_Cash_Payment.xlsx				