...
***Test Cases***
Add value Credit Card with Discount Coupon in Percentage
    Post Setup
    login POST Application
    Verify that all function of Fare card sale page    ${InitialPurse}    ${IssuingFee}    ${CardDeposit}
    ${Amount_payment}    Credit Card with Discount Coupon in Percentage add value and confrim transaction    ${Initial_Add_Value}
    Credit Card with Discount Coupon in Percentage Verify Total payment    ${Amount_payment}
    close Application
...
${Project_Name}    Devlop
${Excelname}    Data_Fare_card_sale_Credit_Card_with_Discount_Coupon_in_Percentage.xlsx