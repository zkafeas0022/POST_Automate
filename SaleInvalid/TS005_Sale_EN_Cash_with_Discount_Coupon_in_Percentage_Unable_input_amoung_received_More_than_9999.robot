...
***Test Cases***
Cash with Discount Coupon in Percentage Unable input amoung received More than 9999
    ...
    \    ${ExecuteTestResult}	Run Keyword And Ignore Error    Cash with Discount Coupon in Percentage Invalid    ${iData}
   Close Application


***Keywords***

Cash with Discount Coupon in Percentage Invalid
    [Arguments]    ${iData}
    Post Setup
    ...
    ${PurseBeforeAddValue}    Verify that all function of Fare card sale page    ${CardDeposit}
    Input Data And Verify Error Message    ${Add_Value}    ${iData}    ${Cash_Amount_Received}    ${Discount_Coupon}    ${Voucher_No}    ${PurseBeforeAddValue}    ${ErrorSummary_excel}    ${ErrorMessage_excel}
...
#Add Value
    Run keyword If    '${Add_Value}'=='100'    Click Button	text:100    ELSE IF    '${Add_Value}'=='200'    Click Button	text:200    ELSE IF    '${Add_Value}'=='300'    Click Button    text:300    ELSE IF    '${Add_Value}'=='500'    Click Button	text:500    ELSE    Input Text To Textbox    id:ControlInitialAddValue_Addvalue_textbox    ${Add_Value}        
...
#Cash Amount Received
    ...
    Run Keyword If   ${Cash_Amount_Received}>9999    Input Text To Textbox    id:ControlCashAmountReceive_CashReceived_textbox    ${Cash_Amount_Received}
    Run Keyword If   ${Cash_Amount_Received}>9999    Attach Window    id:Information_Dialog
    ...
    Run Keyword If    '${Check_Error_AddValue}'=='True' and '${Check_Error_AddValue}'!='None' and '${Check_Error_AddValue}'!='${EMPTY}'   should Contain    ${Text_Error_App_Summary}    ${ErrorSummary_excel}
...
${Project_Name}    Devlop
${Excelname}    Data_Sale_TS005_EN_Cash_with_Discount_Coupon_in_Percentage_Unable_input_amoung_received_More_than_9999.xlsx