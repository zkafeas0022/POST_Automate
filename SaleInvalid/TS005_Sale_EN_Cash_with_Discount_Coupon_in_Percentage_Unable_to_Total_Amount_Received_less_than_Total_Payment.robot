...
***Test Cases***
cash with discount in percentage invalid
    Post Setup
    ...
    \    ${ExecuteTestResult}	Run Keyword And Ignore Error    cash with discount in percentage invalid    ${iData}
   Close Application
...
${Project_Name}    Devlop
${Excelname}    Data_Sale_TS005_EN_Cash_with_Discount_Coupon_in_Percentage_Unable_to_Total_Amount_Received_less_than_Total_Payment.xlsx