...
***Test Cases***
cash with discount coupon in value
    ...
    \    ${ExecuteTestResult}	Run Keyword And Ignore Error    cash with discount coupon in value    ${iData}
   Close Application
...
${Project_Name}    Devlop
${Excelname}    Data_Sale_TS006_EN_Cash_with_Discount_Coupon_in_Value_Unable_input_add_value_More_than_4000_Invalid.xlsx