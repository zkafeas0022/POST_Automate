...
***Test Cases***
credit card with discount coupon in value invalid
    ...
    \    ${ExecuteTestResult}	Run Keyword And Ignore Error    credit card with discount coupon in value invalid    ${iData}
   Close Application
...
${Project_Name}    Devlop
${Excelname}    Data_Sale_TS009_EN_Credit_Card_with_Discount_Coupon_in_Value_Unable_input_add_value_More_than_4000_Invalid.xlsx