...
***Test Cases***
Credit Payment Unable input add value More than 4000 Invalid
    ...
    \    ${ExecuteTestResult}	Run Keyword And Ignore Error    Credit Payment Invalid    ${iData}
   Close Application


***Keywords***

Credit Payment Invalid
    [Arguments]    ${iData}
    Post Setup
    ...
    Verify Error Message Unable input add value    ${Add_Value}    ${iData}    ${Cash_Amount_Received}    ${Discount_Coupon}    ${Voucher_No}    ${PurseBeforeAddValue}    ${ErrorSummary_excel}    ${ErrorMessage_excel}
...
Verify Error Message Unable input add value   
...
${Project_Name}    Devlop
${Excelname}    Data_Sale_TS002_EN-Credit_Card_Payment-Unable_input_add_value_More_than_4000_Invalid.xlsx