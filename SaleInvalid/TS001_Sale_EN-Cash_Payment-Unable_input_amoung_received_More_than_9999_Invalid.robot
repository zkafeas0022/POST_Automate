...
***Test Cases***
Cash Payment Unable input amoung more than 9999 Invalid
    ...
    \    ${ExecuteTestResult}	Run Keyword And Ignore Error    Cash Payment Invalid    ${iData}
   Close Application


***Keywords***

Cash Payment Invalid
    [Arguments]    ${iData}
    Post Setup
...
#Cash Amount Received
    ...
    Run Keyword If   ${Cash_Amount_Received}>9999.99    Attach Window    id:Information_Dialog
    Sleep    3s
...
${Project_Name}    Devlop
${Excelname}    Data_Sale_TS001_EN-Cash_Payment-Unable_input_amoung_received_More_than_9999_Invalid.xlsx