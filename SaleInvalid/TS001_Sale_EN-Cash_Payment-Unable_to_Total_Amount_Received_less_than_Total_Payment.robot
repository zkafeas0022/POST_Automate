...
***Test Cases***
Cash Payment Unable input Total Amount Received less than Total Payment
    Post Setup
...
Verify Error Message Unable input amoung more than   
    ...
    Run keyword If    '${Add_Value}'=='100'    Click Button	text:100    ELSE IF    '${Add_Value}'=='200'    Click Button	text:200    ELSE IF    '${Add_Value}'=='300'    Click Button    text:300    ELSE IF    '${Add_Value}'=='500'    Click Button	text:500    ELSE    Input Text To Textbox    id:ControlInitialAddValue_Addvalue_textboxls    ${Add_Value}        
...
${Project_Name}    Devlop
${Excelname}    Data_Sale_TS001_EN-Cash_Payment-Unable_to_Total_Amount_Received_less_than_Total_Payment_Invalid.xlsx