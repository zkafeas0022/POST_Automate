...
Cash with cash voucher Invalid
    ...
    Verify Error Message Unable input amoung more than    ${Add_Value}    ${iData}    ${Cash_Amount_Received}    ${Voucher_No}    ${PurseBeforeAddValue}    ${ErrorSummary_excel}    ${ErrorMessage_excel}    ${Discount_Coupon}
...
Verify Error Message Unable input amoung more than   
    [Arguments]    ${Add_Value}    ${iData}    ${Cash_Amount_Received}    ${Voucher_No}    ${PurseBeforeAddValue}    ${ErrorSummary_excel}    ${ErrorMessage_excel}    ${Discount_Coupon} 
    Attach Window	id:MainWindow	
...
#Cash Amount Received
    ...
    log    ${Cash_Amount_Received}
    Run Keyword If   ${Cash_Amount_Received}>9999.99    Input Text To Textbox    id:ControlCashAmountReceive_CashReceived_textbox    ${Cash_Amount_Received}
...
${Project_Name}    Devlop
${Excelname}    Data_Sale_TS006_EN_Cash_with_Discount_Coupon_in_Value_Unable_input_amoung_received_More_than_9999_Invalid.xlsx