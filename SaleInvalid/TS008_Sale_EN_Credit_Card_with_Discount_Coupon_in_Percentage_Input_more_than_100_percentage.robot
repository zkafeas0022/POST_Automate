...
***Test Cases***
credit card with Discount Coupon in Percentage Invalid
    ...
    \    ${ExecuteTestResult}	Run Keyword And Ignore Error    credit card with Discount Coupon in Percentage Invalid    ${iData}
   Close Application
...
credit card with Discount Coupon in Percentage Invalid
    ...
    ${CardDeposit}    Get Value Of Test Data Response By Name	${iData}    CardDeposit 
    ...
    Input Data And Verify Error Message    ${Add_Value}    ${iData}    ${Cash_Amount_Received}    ${Discount_Coupon}    ${Credit_Card_No}    ${PurseBeforeAddValue}    ${ErrorSummary_excel}    ${ErrorMessage_excel}
...
Input Data And Verify Error Message
    [Arguments]    ${Add_Value}    ${iData}    ${Cash_Amount_Received}    ${Discount_Coupon}    ${Credit_Card_No}    ${PurseBeforeAddValue}    ${ErrorSummary_excel}    ${ErrorMessage_excel}
...
${Project_Name}    Devlop
${Excelname}    Data_Sale_TS008_EN_Credit_Card_with_Discount_Coupon_in_Percentage-Input_more_than_100_percentage.xlsx