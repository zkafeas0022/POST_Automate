...
Voucher Invalid
    ...
    Verify Error Message    ${Add_Value}    ${iData}    ${Discount_Coupon}    ${Cash_Amount_Received}    ${Voucher_No}    ${PurseBeforeAddValue}    ${ErrorSummary_excel}    ${ErrorMessage_excel}
...
Verify Error Message   
    [Arguments]    ${Add_Value}    ${iData}    ${Discount_Coupon}    ${Cash_Amount_Received}    ${Voucher_No}    ${PurseBeforeAddValue}    ${ErrorSummary_excel}    ${ErrorMessage_excel}
    Attach Window	id:MainWindow	
...
${Project_Name}    Devlop
${Excelname}    Data_Sale_TS006_EN_Cash_with_Discount_Coupon_in_Value_Unable_input_voucher_more_than_add_value.xlsx