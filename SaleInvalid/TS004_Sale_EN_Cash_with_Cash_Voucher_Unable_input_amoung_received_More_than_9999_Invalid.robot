...
unable input amount more than 9999 invalid
    Post Setup
...
Cash with cash voucher Invalid
    ...
    Verify Error Message Unable input amoung more than    ${Add_Value}    ${iData}    ${Cash_Amount_Received}    ${Voucher_No}    ${PurseBeforeAddValue}    ${ErrorSummary_excel}    ${ErrorMessage_excel}
...
Verify Error Message Unable input amoung more than   
    [Arguments]    ${Add_Value}    ${iData}    ${Cash_Amount_Received}    ${Voucher_No}    ${PurseBeforeAddValue}    ${ErrorSummary_excel}    ${ErrorMessage_excel}
    Attach Window	id:MainWindow	
...
${Project_Name}    Devlop
${Excelname}    Data_sale_TS004_EN_Unable_input_amoung_received_More_than_9999_Invalid.xlsx